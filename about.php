                                        ...
                                        <div class="card position-relative">
                                            <div class="card-body">
                                                <div class="col-md-12 mb-4">
                                                    <h4>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Voluptates ipsam, eaque, ullam esse odit dolorum, accusamus odio architecto unde dolores explicabo a dolor? Odio, vel.</h4>
                                                </div>
                                                <div class="col-md-12">
                                                    <h4 class="text-dark">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Consequatur impedit doloremque ratione dolorum ab minima odit suscipit sunt eius modi optio minus asperiores, veritatis vero sit quibusdam excepturi iusto, voluptates quidem reiciendis at? Ipsam esse totam accusantium libero nulla similique iusto. Est et repellendus reiciendis alias facilis rerum debitis architecto.</h4>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
